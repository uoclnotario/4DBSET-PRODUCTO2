...
Listado de tareas para finalizar producto 2.
...
Clase DaoSql.
	...
	[]4-modificar
		-Modificasrá un elemento dependiendo de los diferentes apartados.
	
	[]5-borrar
		-Borrar un elemento de un apartado dado.
	
	[X]6-Login(Testeado y funcionando.)
		-Logea al usuario en la bd.
	
	[]7-getPidaDatosGenerales
